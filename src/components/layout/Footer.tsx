        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#who-it-is-for" className="hover:text-brand-cyan transition-colors">למי זה מיועד</a></li>
              <li><a href="#asset-map-simulation" className="hover:text-brand-cyan transition-colors">סימולציית מפת הנכסים</a></li>
              <li><a href="#how-it-works" className="hover:text-brand-cyan transition-colors">איך זה עובד</a></li>
              <li><a href="#contact" className="hover:text-brand-cyan transition-colors">צור קשר</a></li>
            </ul>
          </div>
