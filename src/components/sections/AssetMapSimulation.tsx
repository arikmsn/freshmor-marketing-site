...
// Hex values for animated color transitions
...
// Classes used only for the legend dots (static, no animation needed)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 lg:items-center">
          ...
          <div className="lg:order-last flex flex-col gap-4">
              ...
              <button
                ...
                className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all border ${
                  isPlaying
                    ...
                    : "bg-brand-surface text-brand-primary border-brand-cyan/20 hover:border-brand-cyan/50"
                }`}
              >
            ...
            >
              ...
              {/* Site dots — motion.div for animated color + entry animation */}
              {SITES.map((site, idx) => {
            ...
            {/* 3. Legend / summary */}
            <motion.div
              className="bg-brand-surface border border-brand-cyan/20 rounded-2xl px-5 py-4"
